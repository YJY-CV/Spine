...
def oks_iou(g, d, a_g, a_d, sigmas=None, in_vis_thre=None):
    if not isinstance(sigmas, np.ndarray):
        ...
        sigmas = np.array([.45, .45, .45, .45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45, .45, .45, .45,.45, .45, .45, .45, .45, .45, .45])/10
    ...
    for n_d in range(0, d.shape[0]):
        ...
        dx = xd - xg
        dy = yd - yg
        e = (dx ** 2 + dy ** 2) / vars_short / ((a_g + a_d[n_d]) / 2 + np.spacing(1)) / 2
